---
description: Operate on the backlog — list, inspect, create, claim, transition, split, and refine tasks.
argument-hint: <list|show|next|new|claim|set-status|split|ac|context|describe|edit> [...]
