<!-- GENERATED by harness v1.0.0 from .harness/commands/task.md — do not edit; run `harness generate` -->

# Runbook: task <list|show|next|new|claim|set-status|split|ac|context|describe|edit> [...]

Operate on the backlog — list, inspect, create, claim, transition, split, and refine tasks.
